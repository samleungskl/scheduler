...
test("1.getInterview returns an object with the interviewer data", () => {
...
test("2.getInterview returns null if no interview is booked", () => {
...
test("3.getInterviewersForDay returns an array containing the correct interviewers objects", () => {
